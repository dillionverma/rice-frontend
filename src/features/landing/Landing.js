                ...
                <div className="flex mobile-flex-wrap mb20 mobile-text-center wow fadeInLeft">
                  <i className="icon secondary-bg mr20 mobile-center-icon">
                    <svg className="svg-fill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
                      <path d="M16 3.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1 0-1h5a.5.5 0 0 1 .5.5zm5-1v20a2.503 2.503 0 0 1-2.5 2.5h-11A2.503 2.503 0 0 1 5 22.5v-20A2.503 2.503 0 0 1 7.5 0h11A2.503 2.503 0 0 1 21 2.5zm-6 20a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0 0 1h3a.5.5 0 0 0 .5-.5zm5-20A1.502 1.502 0 0 0 18.5 1h-11A1.502 1.502 0 0 0 6 2.5V20h14z" />
                    </svg>
                  </i>
                  <div>
